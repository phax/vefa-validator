...
public class XmlUtilsTest
{
  ...
  {
    final String xml = "<test xmlns=\"http://difi.no/xsd/vefa/validator/1.0\" configuration=\"ehf-t10-base-2.0\">";
  ...
  public void simpleTest2 ()
  {
    final String xml = """
        ...
        <!-- Another comment before we start -->
        <?entity data>
        <test xmlns="urn:difi.no/xsd/vefa/validator/1.0" configuration="ehf-t10-base-2.0">
          <something xmlns="urn:else" />
        </test>
        """;
    assertEquals (XmlUtils.extractRootNamespace (xml), "urn:difi.no/xsd/vefa/validator/1.0");
    assertEquals (XmlUtils.extractLocalName (xml), "test");
  }
  ...
  {
    final String xml = "<ubl:Invoice\n" +
                       "    xmlns=\"urn:oasis:names:specification:ubl:schema:xsd:Invoice-2\"\n" +
                       "    xmlns:ubl=\"urn:oasis:names:specification:ubl:schema:xsd:Invoice-2\"\n" +
                       "    xmlns:cac=\"urn:oasis:names:specification:ubl:schema:xsd:CommonAggregateComponents-2\"\n" +
                       "    xmlns:cbc=\"urn:oasis:names:specification:ubl:schema:xsd:CommonBasicComponents-2\"\n" +
                       "    xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\">";
    assertEquals (XmlUtils.extractRootNamespace (xml), "urn:oasis:names:specification:ubl:schema:xsd:Invoice-2");
  ...
  {
    final String xml = "<espd-req:ESPDRequest " +
                       "xmlns:cac=\"urn:oasis:names:specification:ubl:schema:xsd:CommonAggregateComponents-2\" " +
                       "xmlns:cbc=\"urn:oasis:names:specification:ubl:schema:xsd:CommonBasicComponents-2\" " +
    ...
    assertEquals (XmlUtils.extractRootNamespace (xml), "urn:grow:names:specification:ubl:schema:xsd:ESPDRequest-1");
