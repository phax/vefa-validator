...
public class ValidatorModule extends AbstractModule
{
  ...
  protected void configure ()
  {
    ...
    final Multibinder <ITrigger> triggers = Multibinder.newSetBinder (binder (), ITrigger.class);
    triggers.addBinding ().to (AsiceTrigger.class);

    final Multibinder <IDeclaration> declarations = Multibinder.newSetBinder (binder (), IDeclaration.class);
  ...
  @Provides
  @Singleton
  public List <ICheckerFactory> getCheckerFactories (final Set <ICheckerFactory> factories)
  {
  ...
  @Provides
  @Singleton
  public List <ITrigger> getTriggers (final Set <ITrigger> triggers)
  {
