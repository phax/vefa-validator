...
public class ConvertedDocument extends Document {
   ...
   */
  public ConvertedDocument(final ByteArrayInputStream inputStream, final ByteArrayInputStream source,
                           final String declaration, final IExpectation expectation) {
   ...
   */
  public ConvertedDocument(final ByteArrayInputStream inputStream, final ByteArrayInputStream source,
                           final List<String> declarations, final IExpectation expectation) {
